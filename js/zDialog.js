...
Dialog.prototype.create = function () {
    ...
    var html = '\ <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style=" background-color: #ed5d52 ;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-color: #ed5d52 ;"><div style="padding: 3px 0 0 4px; float: left; font-weight: bold; color:#fff;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').close();" onmouseout="this.style.backgroundImage=\'url(' + this.imgurl + 'dialog_closebtn.png) \'" onmouseover="this.style.backgroundImage=\'url(' + this.imgurl + 'dialog_closebtn_over.png)\'" style="margin-top:5px; position: relative; cursor: pointer; float: right; height: 15px; width: 14px; background-image: url(' + this.imgurl + 'dialog_closebtn.png);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-color: #ed5d52;background-color: #ed5d52;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="346" colspan="3" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_' + this.ID + '" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #ed5d52;" id="_MessageTable_' + this.ID + '">\
                <tr>\
                  <td width="50" height="50" align="center"><img width="32" height="32" src="' + this.imgurl + this.MessageIcon + '" id="_MessageIcon_' + this.ID + '"/></td>\
	...
	' + (function (obj) {
	    ...
	    return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36" width="336"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
    ...
    <tr>\
      <td width="13" height="13" style="background-color: #FFFFFF;"></td>\
      <td style="background-color: #FFFFFF;"></td>\
      <td width="13" height="13" style="background-color: #FFFFFF;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
...
Dialog.alert = function (yhfk, msg, img, func, w, h) {
    var w = w || 320,
        h = h || 180;
    var diag = new Dialog({
        Width: w,
    ...
    if (yhfk == "0") {
        ...
        diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\	<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + img + 'icon_alert.gif" width="34" height="34" align="absmiddle"></td>\<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msg + '</td></tr>\</table>';
    }
    else {
        diag.CancelEvent = function () {
            getredio();
        ...
        diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\	<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + img + 'icon_alert.gif" width="34" height="34" align="absmiddle"></td>\<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msg + '</td></tr>\<tr><td colspan="2">自动评估值反馈！</td></tr><tr><td colspan="2"><input id="myd1" type="radio"  name="1" value="高于市场价" />高于市场价<input id="myd2" checked="checked" type="radio"  name="1" value="正常价"/>正常价<input id="myd3" type="radio"  name="1" value="低于市场价"/>低于市场价</td></tr>\</table>';
    }
    diag.show();
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + this.imgurl + 'icon_query.gif" width="34" height="34" align="absmiddle"></td>\
