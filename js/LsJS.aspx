var LR_websiteid = 'DHT17982545';
var LR_siteid = '17982545';
var LR_sysurl = 'http://dht.zoosnet.net/';
var LR_eb203='D36C141A2846481E9B48BDC0CFDB7606';var LR_47454=LR_eb203.replace(/1/g,'3').replace(/0/g,'2');var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_isMobile = 0;
var LR_lng = 'cn';
var LR_js_pm = 'd';
...
var LR_ssl = 0;
var LR_imgurl = 'http://dht.zoosnet.net/';
var LR_3bcba=LR_47454.replace(/1/g,'3').replace(/0/g,'2');var LR_BBOO=LR_3bcba.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fdht.zoosnet.net%2fsite%2f17982545%2fonline_cn.jpg");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fdht.zoosnet.net%2fsite%2f17982545%2foffline_cn.jpg");
	var _lr_closesrc0='spacer.gif';
	...
	LR_hasInstall=0;
	var LR_ivite_img='http://dht.zoosnet.net/site/17982545/invite_share.jpg';
	var LR_invite_color0='#B50005';
	var LR_invite_color1='#B50005';
	var LR_invite_color2='#B50005';
	var LR_invite_color3='#FF8000';
	...
	var _lr_invitestring=unescape("%3cP style%3d%22FONT-SIZE%3a 16px%3b FONT-FAMILY%3a 'Microsoft Yahei'%3b COLOR%3a %23363636%3b LINE-HEIGHT%3a 22px%22%3e%u6b22 %u8fce %u8bbf %u95ee %u539a %u6cfd %u91d1 %u878d %u5b98 %u65b9 %u7f51 %u7ad9%uff01%3cBR%3e%u6709 %u4ec0 %u4e48 %u53ef %u4ee5 %u5e2e %u52a9 %u60a8 %u7684 %u5417%3cBR%3e%3cSPAN style%3d%22FONT-SIZE%3a 12px%3b COLOR%3a %235a5a5a%3b PADDING-TOP%3a 15px%3b DISPLAY%3a block%3b LINE-HEIGHT%3a 12px%22%3e24%u5c0f%u65f6%u514d%u8d39%u670d%u52a1%u70ed%u7ebf%uff1a%3cB style%3d%22FONT-SIZE%3a 12px%3b FONT-WEIGHT%3a 400%3b COLOR%3a %23b50005%3b DISPLAY%3a inline-block%22%3e400-6656-400%3c%2fB%3e %3c%2fSPAN%3e%3c%2fP%3e");
	...
	var LR_invitestring1_auto=unescape("%3cP style%3d%22FONT-SIZE%3a 16px%3b FONT-FAMILY%3a 'Microsoft Yahei'%3b COLOR%3a %23363636%3b LINE-HEIGHT%3a 22px%22%3e%u6b22 %u8fce %u8bbf %u95ee %u539a %u6cfd %u91d1 %u878d %u5b98 %u65b9 %u7f51 %u7ad9%uff01%3cBR%3e%u6709 %u4ec0 %u4e48 %u53ef %u4ee5 %u5e2e %u52a9 %u60a8 %u7684 %u5417%3cBR%3e%3cSPAN style%3d%22FONT-SIZE%3a 12px%3b COLOR%3a %235a5a5a%3b PADDING-TOP%3a 15px%3b DISPLAY%3a block%3b LINE-HEIGHT%3a 12px%22%3e24%u5c0f%u65f6%u514d%u8d39%u670d%u52a1%u70ed%u7ebf%uff1a%3cB style%3d%22FONT-SIZE%3a 12px%3b FONT-WEIGHT%3a 400%3b COLOR%3a %23b50005%3b DISPLAY%3a inline-block%22%3e400-6656-400%3c%2fB%3e %3c%2fSPAN%3e%3c%2fP%3e");
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&KILB='+LR_BBOO;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://dht.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
